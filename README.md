...
Due to file size constraints, the complete ERP dataset cannot be provided in full. I will send you an ERP.FIF file containing only the data from a participant for reference purposes. Please note that this data is intended solely for your review and should not be used for any other purposes.
